...
void FlagCar::init(const glm::ivec2& tileMapPos, ShaderProgram& shaderProgram)
{
...
void FlagCar::update(int deltaTime)
{
...
bool FlagCar::collisionMoveRight(const glm::ivec2& pos, const glm::ivec2& size) {
	int x, y;
...
bool FlagCar::collisionMoveLeft(const glm::ivec2& pos, const glm::ivec2& size) {
	int x, y;
	x = sprite->getposicionx() - 32;
