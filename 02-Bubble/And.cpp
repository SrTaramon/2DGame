...
void And::init(const glm::ivec2& tileMapPos, ShaderProgram& shaderProgram)
{
...
bool And::collisionMoveRight(const glm::ivec2& pos, const glm::ivec2& size) {
	int x, y;
...
bool And::collisionMoveLeft(const glm::ivec2& pos, const glm::ivec2& size) {
	int x, y;
	x = sprite->getposicionx() - 32;
...
bool And::collisionMoveUp(const glm::ivec2& pos, const glm::ivec2& size) {
	int x, y;
	x = sprite->getposicionx() - 32;
	y = sprite->getposiciony() - 16;
...
bool And::collisionMoveDown(const glm::ivec2& pos, const glm::ivec2& size) {
	int x, y;
	x = sprite->getposicionx() - 32;
	y = sprite->getposiciony() - 16;
	int x2 = sprite->getposicionx() - 32 + 32;
