...
void Stop::init(const glm::ivec2& tileMapPos, ShaderProgram& shaderProgram)
{
...
void Stop::update(int deltaTime)
{
...
bool Stop::collisionMoveRight(const glm::ivec2& pos, const glm::ivec2& size) {
	int x, y;
...
bool Stop::collisionMoveLeft(const glm::ivec2& pos, const glm::ivec2& size) {
	int x, y;
	x = sprite->getposicionx() - 32;
	y = sprite->getposiciony() - 16;
	int y2 = sprite->getposiciony() - 16 + 32;
...
bool Stop::collisionMoveUp(const glm::ivec2& pos, const glm::ivec2& size) {
	int x, y;
	x = sprite->getposicionx() - 32;
	y = sprite->getposiciony() - 16;
...
bool Stop::collisionMoveDown(const glm::ivec2& pos, const glm::ivec2& size) {
	int x, y;
	x = sprite->getposicionx() - 32;
	y = sprite->getposiciony() - 16;
	int x2 = sprite->getposicionx() - 32 + 32;
